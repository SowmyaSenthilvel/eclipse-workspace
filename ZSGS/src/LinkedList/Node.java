		...
		do{
			...
			switch(choice){
				...
				case 1: System.out.println("Enter the element to be inserted: ");
					...
					break;
				case 2: System.out.println("Enter index to be deleted: ");
					ele = sc.nextInt();
					deleteElement(node,ele);
					System.out.println("Element "+ele+" deleted");
					break;
				case 3: System.out.println("Enter the element to be inserted at head of linked list");
					ele = sc.nextInt();
				...
				case 6: System.out.println("Quitting.. Bye!!");
					System.exit(0);
